            ...
            <footer className={styles.footer}>
                ...
                <nav>
                    <div className={styles.firstLineFooter}>
                        <p> <a href="/#doyoulikefishsticks?" className={styles.logo}><img src="/images/logo.png" alt="Trade Me Logo" title="Trade Me" /></a>
                ...
                <nav className={styles.gridRow} id={styles["box1"]}>
                    <div className={styles.gridCol}>
                        <p><a href="/#doyoulikefishsticks?">Marketplace</a>
